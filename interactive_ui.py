...
# ========================================================
    ...
    with tab_trace:
        ...
        if not run_multi_agent:
            st.info("Le workflow multi-agent n'a pas été activé.")
        elif not raw_history:
            st.warning("Aucune trace disponible.")
        else:
            st.caption("Trace brute complète du raisonnement et des échanges entre agents")

            turn_buffer = []
            current_turn = "Initialisation"
