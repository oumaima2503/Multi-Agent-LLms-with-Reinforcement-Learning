...
- **Échantillons d'entraînement**: 18000
- **Échantillons de validation**: 500
- **Source**: /kaggle/input/processed-sft/processed_sft/orchestrator_sft.jsonl
...
model = PeftModel.from_pretrained(base_model, '/kaggle/working/checkpoints/orchestrator_lora')
tokenizer = AutoTokenizer.from_pretrained('/kaggle/working/checkpoints/orchestrator_lora')
```
